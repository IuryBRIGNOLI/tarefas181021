...
***********************************************************************************************************************************************
#diferença: for vai executar as instruções através de uma sequência conhecida for  - percorrer listas, vetores, executar um número definido x de ações e outros. Enquanto o while vai executar as instruções até que a(s) condição(ões) seja(m) atendida(s) while .
